...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('Icon.png') }}">    <!-- Tailwind -->
...
<body class="bg-gray-100 font-family-karla w-auto flex">
    ...
    <div class="p-6">
        <div class="flex items-center">
            <a href="{{ route('task.index') }}">
                <img src="{{ asset('Icon.png') }}" alt="Logo" class="h-12 w-12 mr-2 logo-image">
            </a>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            ...
            Task Manager By: <a target="_blank" href="#" class="underline"> John Ulysses N. Paruginog</a>.
            </footer>
        </div>
